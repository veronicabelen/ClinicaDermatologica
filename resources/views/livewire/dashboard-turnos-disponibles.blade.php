    ...
    <div class="flex flex-col items-center gap-8 mt-6"> {{-- Aumentado el gap para espacio entre filas --}}
        ...
        <div class="flex justify-center gap-12"> {{-- gap-12 para separación horizontal entre cards --}}
            ...
            <div class="flex flex-col items-center">
                <img src="{{ asset('images/HidrataciónProfundaConAcidoHialurónico.jpg') }}" alt="Hidratación Profunda"
                    class="w-48 h-48 object-cover rounded-lg shadow-md
                    transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg
                    cursor-pointer">
                <p class="mt-2 text-center text-sm text-white-700">Hidratación Profunda</p>
            </div>
            ...
            <div class="flex flex-col items-center">
                <img src="{{ asset('images/LimpiezaFacialProfunda.jpg') }}" alt="Limpieza Facial Profunda"
                    ...
                    transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg
                    cursor-pointer">
                <p class="mt-2 text-center text-sm text-white-700">Limpieza Facial Profunda</p>
            </div>
            ...
            <div class="flex flex-col items-center">
                <img src="{{ asset('images/aparatologia.jpg') }}" alt="Aparatología"
                    ...
                    transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg
                    cursor-pointer">
                <p class="mt-2 text-center text-sm text-white-700">Aparatología</p>
            </div>
        </div>
        ...
        <div class="flex justify-center gap-12"> {{-- gap-12 para separación horizontal entre cards --}}
            ...
            <div class="flex flex-col items-center">
                <img src="{{ asset('images/cosmetologia.jpg') }}" alt="Cosmetología"
                    ...
                    transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg
                    cursor-pointer">
                <p class="mt-2 text-center text-sm text-white-700">Cosmetología</p>
            </div>
            ...
            <div class="flex flex-col items-center">
                <img src="{{ asset('images/ventajas.jpg') }}" alt="Ventajas"
                    ...
                    transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg
                    cursor-pointer">
                <p class="mt-2 text-center text-sm text-white-700">Ventajas del Tratamiento</p>
            </div>
            ...
            <div class="flex flex-col items-center">
                <img src="{{ asset('images/PeelingQuímicoSuave.jpg') }}" alt="Peeling Químico Suave"
                    ...
                    transition duration-300 ease-in-out transform hover:scale-105 hover:shadow-lg
                    cursor-pointer">
                <p class="mt-2 text-center text-sm text-white-700">Peeling Químico Suave</p>
            </div>
        </div>
