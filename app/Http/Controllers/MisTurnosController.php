...
class MisTurnosController extends Controller
{
    ...
    {
        // Cargar los turnos del usuario autenticado, incluyendo las relaciones 'tratamiento' y 'medico'
        $turnos = Auth::user()->turnos()->with(['tratamiento', 'medico'])->get();

        return view('mis-turnos', compact('turnos'));
    }
